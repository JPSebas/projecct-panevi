				...
				<div class="row">
					<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
						<article class="post-grid mb-5">
							...
							<h2 style="color: #000000;" class="mb-2 mt-2 post-title"><strong>Sobre Nosotros</strong></h2>
						...
						<div class="sidebar sidebar-right">
							<div class="sidebar-wrap mt-5 mt-lg-0">
								...
								<div class="sidebar-widget about mb-5  p-3">
									...
									<p style="font-size: 17px; text-align:justify;">En Panevi, aspiramos a ser líderes en el mercado de productos de panela, reconocidos por nuestra calidad, sostenibilidad y compromiso con la salud y el bienestar de nuestros clientes. Nos envisionamos como un puente entre los consumidores conscientes y los productores locales, promoviendo prácticas agrícolas sostenibles y justas que beneficien tanto a las personas como al medio ambiente. A través de la innovación y la educación, buscamos crear una comunidad global que valore y aprecie la pureza y los beneficios de la panela.</p>
									<img src="img/.q3.jpg" alt="" class="img-fluid">
								</div>
