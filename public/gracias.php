...
<body>
    ...
    <br>
    <br>
    <div style="text-align: center; background: linear-gradient(to right, #f9f9f9, #f1f1f1); padding: 50px; border-radius: 10px; box-shadow: 0 0 20px rgba(0, 0, 0, 0.1); position: relative; overflow: hidden;">
    <h1 style="font-size: 5em; font-weight: bold; color: #275d1e; margin-bottom: 20px;">¡Gracias por tu Compra!</h1>
    <p style="font-size: 1.5em; color: #333333; margin-bottom: 20px;">Tu apoyo nos permite seguir ofreciendo productos de calidad. Esperamos que disfrutes de tus compras y te invitamos a seguir explorando nuestras ofertas y productos únicos.</p>
    <p style="font-size: 1.2em; color: #555555;">Si necesitas más información o tienes alguna pregunta, no dudes en contactarnos.</p>
    <?php
    ...
    <i class="fas fa-star" style="position: absolute; top: 10px; left: 20px; font-size: 5em; color: rgba(255, 215, 0, 0.2);"></i>
    <i class="fas fa-heart" style="position: absolute; top: 50px; right: 30px; font-size: 4em; color: rgba(255, 0, 0, 0.2);"></i>
    <i class="fas fa-gift" style="position: absolute; bottom: 40px; left: 40px; font-size: 6em; color: rgba(0, 128, 0, 0.2);"></i>
    <i class="fas fa-shopping-bag" style="position: absolute; bottom: 10px; right: 10px; font-size: 5em; color: rgba(0, 0, 255, 0.2);"></i>
    <i class="fas fa-thumbs-up" style="position: absolute; top: 70px; left: 60px; font-size: 5em; color: rgba(0, 255, 0, 0.2);"></i>
    <i class="fas fa-smile" style="position: absolute; bottom: 70px; right: 60px; font-size: 4em; color: rgba(255, 165, 0, 0.2);"></i>
    <i class="fas fa-check-circle" style="position: absolute; top: 210px; left: 160px; font-size: 6em; color: rgba(0, 0, 128, 0.2);"></i>
    <i class="fas fa-hand-holding-heart" style="position: absolute; bottom: 150px; right: 200px; font-size: 6em; color: rgba(255, 20, 147, 0.2);"></i>
</div>
