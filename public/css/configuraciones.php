...
<body>
    ...
    <label for="nuevo_email"><center><b>Nuevo Correo Electrónico</b></center></label>
    <input type="email" id="nuevo_email" name="nuevo_email">
    <br><br>
    
    <label for="password_actual"><center><b>Contraseña Actual</b></center></label>
    <input type="password" id="password_actual" name="password_actual">
    <br><br>

    <label for="nueva_password"><center><b>Nueva Contraseña</b></center></label>
...
/* Mensaje de alerta */
.mensaje-alerta {
    color: <?= strpos($mensaje, 'correctamente') !== false ? 'green' : 'red' ?>;
    font-weight: bold;
    padding: 10px;
    border: 1px solid <?= strpos($mensaje, 'correctamente') !== false ? 'green' : 'red' ?>;
    border-radius: 5px;
    background-color: <?= strpos($mensaje, 'correctamente') !== false ? '#d4edda' : '#f8d7da' ?>;
    font-size: 14px;
