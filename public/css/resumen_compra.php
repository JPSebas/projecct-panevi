...
?>
			...
			<div class="col-md-6 formulario-pago">
				...
				<div class="form-check">
					<input class="form-check-input" type="radio" name="tipo_pago" id="pago_domicilio" value="domicilio" checked onclick="mostrarFormulario('domicilio')">
	...
	<input type="hidden" name="carrito" value='<?php echo json_encode($carrito); ?>'>
        ...
        <button type="submit" class="btn btn-success btn-block mt-3 font-weight-bold" 
            style="
